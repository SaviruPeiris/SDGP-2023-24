...
const ImageUploadAwareness = () => {
    return (
        <div className='font-serif  ' style={{ paddingRight:"40px", paddingLeft:"40px"}}>
            <div className='text-center p-12'>
                <h1 className="text-5xl font-bold text-purple-600 underline">Upload your MRI scan</h1>
            </div>

            <div className='bg-indigo-200 rounded-lg shadow-xl p-8'>
                <img className='float-left w-[550px] h-auto mr-10 rounded-lg mt-2 mb-4 shadow-lg' src={brain_scan} alt="image"  />
            ...
            <div className='text-center mt-20 mb-20'>
                <h1 className='mb-10 text-5xl font-bold text-purple-600'>Empowering Users Through Knowledge</h1>
