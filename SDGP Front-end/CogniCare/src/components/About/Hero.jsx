...
const Hero = () => {
  ...
  return (
    ...
    //   <div
    //     className="max-w-[1160px] mx-auto grid md:grid-cols-2 gap-10 items-center justify-center text-center"
    //     data-aos="zoom-in"
    //   >
    //     <img
    //       className="w-full md:w-[850px] h-auto mx-auto my-1 rounded-md"
    //       src={Dementia}
    //       alt="Laptop"
    //     />
