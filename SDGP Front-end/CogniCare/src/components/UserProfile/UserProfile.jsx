        ...
        <div className=" py-10 px-10 justify-center">
            <div className=" w-full ">
                ...
                <div className="mb-2 flex justify-end mr-6">
                    <button
                        className="text-lg bg-green-500 hover:bg-green-700 transform transition duration-500 hover:scale-105 text-white font-bold py-2 px-4 rounded "
                    >
                        My Appointments
                    </button>
                ...
                <div className=" p-5 font-calibri ">
                    <div className=' border-4 border-gray-600 rounded-xl shadow-2xl p-10 bg-gray-500 bg-opacity-70'>
                        ...
                        <div className="mt-5 mb-10 flex justify-between">
                            <div className="ml-10 w-1/3 mr-4">
                                ...
                                {editMode ? (
                                    ...
                                    <div className="mt-3 text-white text-2xl font-bold">
                                        ...
                                        {userData.existingDiseases.split('\n').map((disease, index) => (
                                            <div key={index}>
                                                <span>&#8226;</span> {disease}
                                            </div>
                                        ))}
                            ...
                            <div className="w-1/3 mr-20">
                                <label className="text-3xl font-bold">Current Medications:</label>
                                {editMode ? (
                                    <textarea
                                        className="border border-gray-700 rounded w-full py-3 px-3 text-gray-700 mt-3"
                                    ...
                                    <div className="mt-3 text-white text-2xl font-bold">
                                        ...
                                        {userData.currentMedications.split('\n').map((medication, index) => (
                                            <div key={index}>
                        ...
                        <>
                            ...
                            <div className="ml-10 w-1/3">
                                ...
                                />
                                {passwordMatchError && (
                                    <p className="text-red-700 text-m mt-1">Password doesn't match</p>
                                )}
                            </div>
