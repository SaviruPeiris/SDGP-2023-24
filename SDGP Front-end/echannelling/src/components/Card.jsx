...
const Card = ({ psychologist, onBookClick, onSendAppointmentInfo, lastId }) => {
  ...
  const { image, name, specializations, contactInformation, hospital, workingHours, field } = psychologist;
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between mt-8">
      <div className="text-center mb-6">
        ...
        <p className="text-red-500 text-lg">{hospital}</p>
      </div>
      <div className="mb-6">
      ...
      <div>
        <p className="text-lg"><strong>Field:</strong> {field || 'Field not provided'}</p>
